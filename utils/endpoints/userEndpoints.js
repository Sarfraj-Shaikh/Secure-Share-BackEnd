...
import { multerUpload, uploadFileVal } from "../../middlewares/files.middleware.js";
...
export const userEnpoints = (app) => {
    ...
    app.post("/api/file", roleValidation, multerUpload.single("file"), uploadFileVal, uploadFile);
